                ...
                <GridCont numero={7} grande={3}>
                    {imagenes.map((imagen, index) => (
                        <div key={index}>
                            ...
                            >
                                <Image className="w-[100%]" quality={20} placeholder="blur" blurDataURL="data:image/svg+xml;base64,..." src={imagen.src} width={500} height={500} alt='fotito' />
                            </AnimComponent>
                        </div>
                    ))}
